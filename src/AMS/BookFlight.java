       ...
       ch1.setFont(f1);
        ...
        tf1.setFont(f1);
         tf2.setFont(f1);
          ...
          l1.setForeground(new java.awt.Color(103,3,173));
          ...
          ch4.addMouseListener(new MouseAdapter()
                {
                    ...
                    public void mouseClicked(MouseEvent arg0)
                    {
                        ...
                        try
                        {
                            ...
                            String q1="select f_code from flight where source='"+source+"' and destination ='"+destination+"' and class_name='"+classname+"' and price='"+price+"'";
                            ResultSet rest1=obj.stm.executeQuery(q1);
                            while(rest1.next())
                            {
          ...
          ch5.addMouseListener(new MouseAdapter()
                {
                    ...
                    public void mouseClicked(MouseEvent arg0)
                    {
                        ...
                        try
                        {
                            ...
                            String q1="select f_name from flight where source='"+source+"' and destination ='"+destination+"' and class_name='"+classname+"' and f_code='"+fcode+"'and price='"+price+"'";
                            ResultSet rest1=obj.stm.executeQuery(q1);
                            while(rest1.next())
                            {
